...
function SearchAPI({handleOneMovie}) {
  ...
  return (
    <div>
      ...
      <button type="button" onClick={handleMovies}>Envoyer</button>
      <div className={styles.allMoviesContainer}>
        {movies.map((movie) => (
          <button key={movie.id} type="button" onClick={handleOneMovie} className={styles.movieContainer}>
            <div className={styles.fakeDivToClick} id={movie.id}></div>
